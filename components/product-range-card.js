...
export default function ProductRangeCard({ title, image }) {
  return (
    <div className='bg-gray-100 group flex h-40 lg:h-48 rounded-lg border shadow-md max-w-xs md:max-w-none overflow-hidden border-b-8 border-b-transparent hover:border-b-blue-700 cursor-pointer'>
